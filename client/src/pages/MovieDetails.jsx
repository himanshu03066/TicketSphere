      ...
      <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <div className="flex items-center flex-wrap gap-4 mt-4">
            ...
            <button onClick={handleFavorite} className="bg-gray-700 p-2.5 rounded-full transition cursor-pointer active:scale-96">
              <Heart className={`w-5 h-5 fa ${favoriteMovies.find(movie=> movie._id===id)
  ...
  <div className='flex items-center gap-6 w-max px-4'>
    {show.movie.casts.slice(0, 12).map((cast, index) => (
      <div key={index} className='flex flex-col items-center text-center'>
        <img src={ image_base_url+cast.profile_path} alt=""  className='rounded-full h-21 md:h-21 aspect-square object-cover'/>
