...
// Cancels unpaid bookings and releases the reserved seats automatically after 10 minutes.
...
//inngest function to send email when user book a shoow
...
<strong>Time:</strong> ${new Date(booking.show.showDateTime).toLocaleTimeString('en-US', { timeZone: 'Asia/Kolkata' })}
      ...
      <p>Enjoy the show! 🍿</p>
      <p>Thanks for booking with us!<br/>– TicketSphere Team</p>
    </div>
  `,
});
  }
...
const results = await step.run('send-all-reminders', async () => {
  ...
  <div style="font-family: Arial, sans-serif; padding: 20px;">
    ...
    <br/>
    <p>Enjoy the show!<br/>TicketSphere Team</p>
  </div>
`
    }))
  )
...
const sendNewShowNotifications = inngest.createFunction(
  ...
  async ({ event }) => {
    ...
    <br/>
    <p>Thanks,<br/>TicketSphere Team</p>
  </div>`;
